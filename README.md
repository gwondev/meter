...
- **공통 지표 `fillPercent`**: 0=수거 불필요 · 100=즉시 수거. 수치 산출은 모듈(보드)에서 한다.
- **통합 관제**: 의류·플라스틱·캔·폐의약품 거점을 한 지도에서 관리
- **AI 안내**: 촬영 기반 품목 인식 및 배출·투입 위치 안내
- **수거 효율**: 화면 내 모듈 전부 방문 · 만재 우선 · 도로망 경로
...
화이트 & 블랙 다크 UI — `#0a0a0a` 배경, 적재 상태는 빨강/주황/초록.
